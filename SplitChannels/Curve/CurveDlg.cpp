...
CCurveDlg::CCurveDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_CURVE_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CCurveDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(TCN_SELCHANGE, IDC_TAB1, &CCurveDlg::OnTcnSelchangeTab1)
END_MESSAGE_MAP()
...
void CCurveDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
